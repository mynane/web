...
(function () {
    ...
    ui.FormatInput = core.inherits(
        ...
        },
        {
             ...
             */
            $change: function () {
                ui.InputControl.prototype.$change.call(this);
                if (this._ePlaceHolder) {
    ...
    ui.MonthView = core.inherits(
        ...
        },
        {
            ...
            $ready: function (options) {
                ...
                this.setView(this._oDate.getYear(), this._oDate.getMonth() + 1);
            },
...
(function () {
    ...
    function callRoute(name, options) {
        function checkURLChange() {
            if (currLocation !== core.esr.getLocation()) {
                currLocation = core.esr.getLocation();
                pauseStatus = false;
                item();
            }
        }
            ...
            if (!route.onrender || route.onrender() !== false) {
                if (checkLeave) {
                    ...
                    for (var i = 0, item; item = items[i++]; ) {
                        if (item.route && item.route.onleave && item.route.onleave() === false) {
                            if (options !== true) {
